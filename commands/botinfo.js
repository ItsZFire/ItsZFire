...
module.exports.run = async (bot, message, args) => {
    ...
    .setURL(``)
    .setTimestamp()
    .setTitle(`Click here to join Next RK Studio discord server`)
    ...
    .addField(`:tools: Debug`, `Updated to version ${version}, new commands - Fun Commands!\To invite Next RK Studio in to your server! type "z!invite"\nCheck out try z!help in the chat!`)
